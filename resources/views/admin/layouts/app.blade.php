        ...
        <aside class="w-64 bg-white shadow-sm border-r border-gray-200">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('admin.banners.index') }}"
                    class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.banners.*') ? 'text-blue-700 bg-blue-50' : 'text-gray-700 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
